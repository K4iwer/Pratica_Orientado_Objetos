...
*/     // skill issue + vc tinha feito os construtores errado + Ratio + L + 0 RIZZ + suck my balls
...
Sinal* ModuloRealimentado :: processar(Sinal* sinalIN)
{
    ...
    int vInicial = 0;                                           // no menu tem q deletar os bagui?? (acho q n tá deletando)
...
// da ctr - pra ver a imagem completa. Desculpa -Lucas
